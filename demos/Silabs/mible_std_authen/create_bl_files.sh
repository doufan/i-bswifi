...
if [[ -z ${PATH_GCCARM} ]]; then
  OBJCOPY="/home/hdf/Desktop/SimplicityStudio_v4/developer/toolchains/gnu_arm/7.2_2017q4/bin/arm-none-eabi-objcopy"
...
if [[ -z ${PATH_SCMD} ]]; then
  COMMANDER="/home/hdf/Desktop/SimplicityStudio_v4/developer/adapter_packs/commander/commander"
